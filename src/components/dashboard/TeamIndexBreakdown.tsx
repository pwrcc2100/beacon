            ...
            return (
              ...
              >
                ...
                <td className="py-3 px-4 text-center">
                  <span
                    className="inline-block rounded-bi-sm px-2 py-0.5 text-xs font-medium"
                    style={{
                      background:
                        status === 'Elevated risk'
                          ...
                          : status === 'Emerging risk'
                            ...
                            : 'var(--bi-surface-alt)',
                      color:
                        status === 'Elevated risk' || status === 'Emerging risk'
                          ? 'var(--bi-bg)'
                          : 'var(--bi-text-muted)',
                    }}
                  >
                ...
                <td className="py-3 px-4 text-center text-bi-textMuted">
                  —
                </td>
              </tr>
            );

      ...
      <section className="bg-gradient-to-br from-[#2B4162] via-[#5d89a9] to-[#64afac] py-20">
        <div className="max-w-4xl mx-auto px-6 text-center text-white">
          ...
          <p className="text-xl leading-relaxed opacity-90">
            Everything you need to monitor, understand, and monitor and improve psychosocial risk—from 
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-sm text-[#737A8C]">
                Executive dashboard with Beacon Index score, trend analysis, and drill-down by division, 
                department, and team.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-sm text-[#737A8C]">
                Get notified when Beacon Index scores drop below thresholds or when response rates indicate 
                engagement issues.
              </p>
            </div>
